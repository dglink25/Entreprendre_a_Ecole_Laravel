                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('type') is-invalid @enderror" 
                                                ...
                                                <option value="entreprise_incube" {{ old('type') == 'entreprise_incube' ? 'selected' : '' }}>
                                                    Entreprise incubée
                                                </option>
                                                <option value="entreprise_alumni" {{ old('type') == 'entreprise_alumni' ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                                  ...
                                                  name="description" 
                                                  rows="4" 
                                                  placeholder="Décrivez l'entreprise...">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control @error('mission') is-invalid @enderror" 
                                                      ...
                                                      name="mission" 
                                                      rows="3" 
                                                      placeholder="Mission de l'entreprise...">{{ old('mission') }}</textarea>
                                            @error('mission')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control @error('vision') is-invalid @enderror" 
                                                      ...
                                                      name="vision" 
                                                      rows="3" 
                                                      placeholder="Vision de l'entreprise...">{{ old('vision') }}</textarea>
                                            @error('vision')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control @error('fondateurs') is-invalid @enderror" 
                                                      ...
                                                      name="fondateurs" 
                                                      rows="2" 
                                                      placeholder="Noms des fondateurs...">{{ old('fondateurs') }}</textarea>
                                            @error('fondateurs')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="url" 
                                                   ...
                                                   id="fichier_url" 
                                                   name="fichier_url" 
                                                   value="{{ old('fichier_url') }}"
                                                   required
                                                   placeholder="https://docs.google.com/...">
                                            @error('fichier_url')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Lien vers la documentation de l'entreprise</small>
                                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('entreprises.index') }}" class="btn btn-outline-secondary">
                                        <i class="fas fa-times me-1"></i> Annuler
                                    </a>
                                    <button type="submit" class="btn btn-primary px-4">
                                        <i class="fas fa-save me-1"></i> Enregistrer l'entreprise
                                    </button>
                                </div>
                            </div>
                        </div>
