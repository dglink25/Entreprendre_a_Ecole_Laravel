<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-bold text-2xl text-gray-800">Modifier le domaine</h2>
    </x-slot>
        ...
        <div class="bg-white p-6 rounded-xl shadow">
            ...
            <form action="{{ route('domaines.update', $domaine->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nom" value="{{ $domaine->nom }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" rows="4"
                              class="w-full border-gray-300 rounded-lg">{{ $domaine->description }}</textarea>
                </div>
